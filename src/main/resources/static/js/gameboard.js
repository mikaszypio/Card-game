...
$(document).on('mouseover', '.gb-card', function(event) {
	previewCard(this);
});

$(document).on('mouseout', '.gb-card', function(event) {
	$( "#gb-preview" ).empty();
});

$(document).on('mouseover', '.gb-portrait', function(event) {
	previewCharacter(this);
});

$(document).on('mouseout', '.gb-portrait', function(event) {
	$( "#gb-preview" ).empty();
});